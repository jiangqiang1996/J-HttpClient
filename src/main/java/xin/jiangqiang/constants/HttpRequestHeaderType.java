package xin.jiangqiang.constants;

/**
 * @author jiangqiang
 * @date 2021/1/4 10:12
 */
public final class HttpRequestHeaderType {
    ...
    public final static String ACCESS_CONTROL_ALLOW_CREDENTIALS = "Access_Control_Allow_Credentials";
    public final static String ACCESS_CONTROL_ALLOW_HEADERS = "Access_Control_Allow_Headers";
    public final static String ACCESS_CONTROL_ALLOW_METHODS = "Access_Control_Allow_Methods";
